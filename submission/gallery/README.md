...
Upload-ready assets for the Devpost gallery (3:2). Live screenshots are real
captures of the deployed app; brand assets are rendered from `../brand.html`.

## Screenshots (the live app)
- `gallery-01-landing-hero.png` — landing hero ("It detects the outage and fixes the root cause, but never without your approval").
- `gallery-02-demo-idle.png` — Mission Control, standby.
...
- `gallery-05-declined.png` — the deny path: rejected, production untouched, audited as declined.
...
gallery-05-declined, gallery-04-resolved, gallery-01-landing-hero, brand-01-logo.
